...
namespace GodSharp.Data.Common.DbProvider
{
    ...
    public class DbProviderManager
    {
        ...
        /// The connections
        /// </summary>
        internal static IDictionary<string, DbConnectionSetting> Connections;
        ...
        public static void LoadConfiguration(IConfiguration configuration)
        {
            ...
            List<DbConnectionSetting> co = new List<DbConnectionSetting>();
        ...
        internal static DbConnectionSetting GetConnectionString(string connectionStringName)
        {
